...
class CreateOffer extends Component {
    ...
    handleLoanTokenAmountChange = (event) => {
        const state = this.state;
        state['loanTokenAmount'] = event.target.value;
        state['totalCostAmount'] = event.target.value * this.state.loanCostTokenAmount;
    ...
    handleCostAmountChange = (event) => {
        const state = this.state;
        state['loanCostTokenAmount'] = event.target.value;
        state['totalCostAmount'] = event.target.value * this.state.loanTokenAmount;
                    ...
                    <Col sm={10}>
                        <InputGroup>
                            <Input value={loanTokenAmount} type="number" name="quantity" id="quantity"
                               placeholder="1000" onChange={this.handleLoanTokenAmountChange} />
